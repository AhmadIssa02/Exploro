  ...
  return (
    <div className="bg-primary-500 text-white  poppins-semibold min-h-screen">
        ...
        <div className="flex flex-col gap-x-4 gap-y-4 mt-20">
          <div className="flex justify-center items-center gap-x-5 ">
            <div className="w-1/4 flex justify-center">
              <Image src="/images/community4.png" alt="community" width={210} height={210} layout="intrinsic" />
            </div>
          ...
          <div className="flex justify-center items-center gap-x-5 ">
            ...
            <div className="w-1/4 flex justify-center">
              <Image src="/images/share.png" alt="share" width={210} height={210} layout="intrinsic" />
            </div>
          </div>

          <div className="flex justify-center items-center gap-x-5 ">
            <div className="w-1/4 flex justify-center">
              <Image src="/images/calendar.png" alt="calendar" width={210} height={210} layout="intrinsic" />
            </div>
            <div className="flex flex-col w-1/3 items-center text-center">
      ...
      <div className="flex flex-row ">
        <Image src="/images/phone.svg" alt="community" width={250} height={800} layout="intrinsic" className="mr-auto ml-44 mt-16"/>
