    ...
    return (
        <>
            ...
            <div id="home" className="">
                <div className="flex ">
                    <div className="poppins-bold text-4xl lg:text-6xl ml-28 mt-36 lg:mt-28 mb-12">Your Gateway to <br></br> <div className='text-secondary-500 mt-6'>Global Exploration</div></div>
            ...
            <div id="community" className="flex flex-row ">
                <Image
                    ...
                    width={220}
                    height={800}
                    className="mr-auto ml-36 lg:ml-56 mt-16"
                    style={{
                        maxWidth: "100%",
                        height: "auto"
                    }} />
                <div className="poppins-bold text-3xl lg:text-4xl w-1/2 p-12 mt-28 ml-auto mr-16">Join our community and unlock a world of travel opportunities. </div>
            </div>
            <div className="flex justify-center items-center">
                <button className="font-medium poppins ml-auto mr-20 lg:mr-36 mb-12 p-3 rounded-xl text-2xl text-black bg-secondary-500 shadow-2xl hover:bg-secondary-700  ">
